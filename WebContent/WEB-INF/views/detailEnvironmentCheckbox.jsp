...
<div class="multipl-image-checkbox"> 
   <ul>
        <li><input type="checkbox" id="family_c" class="en1" disabled="disabled" ${dto.family == 1 ? "checked='checked'" : "" }/>
    ...
    <li>
    <input type="checkbox" id="other_animal_c" class="en2"  disabled="disabled"${dto.other_animal == 1 ? "checked='checked'" : "" }/>
    ...
    <li><input type="checkbox" id="kids_c" class="en3" disabled="disabled" ${dto.kids == 1 ? "checked='checked'" : "" }/>
    ...
    <li><input type="checkbox" id="garden_c" class="en4"  disabled="disabled"${dto.garden == 1 ? "checked='checked'" : "" }/>
