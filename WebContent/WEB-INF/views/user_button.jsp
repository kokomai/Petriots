...
<div id="vn-click-user${nickName}" class="vn-click-user">
${nickName}
</div>

<div id="vn-info-user${nickName}" class="vn-info-user">
	<ul style="padding-inline-start: 0px;">
		<li><a href="#myModal${nickName}"  data-toggle="modal" data-target="#myModal${nickName}">쪽지보내기</a></li>
		<li><a href="#myModal2${nickName}"  data-toggle="modal" data-target="#myModal2${nickName}">신고하기</a></li>
	</ul>
</div>

<div class="modal fade" id="myModal${nickName}" role="dialog">
				...
				<div id="content">
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" id="msgReceiver${nickName}" class="form-control" value="${nickName}" readonly="readonly"/>
						</div>
						<br />
						<div class="input-group">
							<div class="input-group-addon">보낸이</div>
							<input type="text" id="msgSender${nickName}" class="form-control" value="${sessionScope.login.getUserId() }" readonly="readonly"/>
						</div>
						<br>
						<div class="input-group">
							<div class="input-group-addon">쪽지내용</div>
							<textarea rows="5" cols="60" class="wrap form-control" style="resize: none;"
								id ="msgContents${nickName}" required="required"></textarea>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button id="modalSubmit${nickName}" type="button" class="btn btn-primary">보내기</button>
...
<div class="modal fade" id="myModal2${nickName}" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<div id="content">
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" id="reportWho${nickName}" class="form-control" value="${nickName}" readonly="readonly"/>
						</div>
						<br />
						<div class="input-group" style="width:100%;">
							<div class="input-group-addon">신고사유</div>
							<select name="reason" required="required" id="reason${nickName}" style="width:100%;">
						...
						<div class="input-group">
							...
							<textarea rows="5" cols="60" class="wrap form-control" style="resize: none;"
								id ="reportContents${nickName}" required="required"></textarea>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button id="modalSubmit2${nickName}" type="button" class="btn btn-primary">신고하기</button>
					<button type="button" class="btn btn-danger" data-dismiss="modal">닫기</button>
				</div>
			</form>
			</div>
