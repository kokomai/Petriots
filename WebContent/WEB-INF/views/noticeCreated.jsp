...
function sendIt()
{
	...
	f.action = "<%=cp%>/noticecreatedok.action";
	...
	<form method="post" name="myForm">
		<table class="table table-borderd" id="tblAdd">
			<tr>
				...
				<td>
					<input type="text" name="adminId" class="form-control" size="35" maxlength="20" placeholder="이름을 입력하세요">
				</td>
			</tr>
			...
			<tr>
				<th>제목</th>
				<td>
					<input type="text" name="subject" class="form-control" size="74" maxlength="100" placeholder="제목을 입력하세요">
				</td>
			</tr>
		...
		<div id="bbsCreated_footer">
			...
			<input type="reset" value="다시입력" class="btn btn-info" onclick="document.myForm.subject.focus()">
			<input type="button" value="작성취소" class="btn btn-danger" onclick="javascript:location.href='<%=cp%>/noticelist.action'">			
