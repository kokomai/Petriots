...
<title>adminExamKnowledgeSearch.jsp</title>
...
<script type="text/javascript">
   ...
   $(function()
   {
      $(".btnUpdate").on("click", function()
      {
         ...
         $("#num").val($(this).val());
         $("#num").val($(this).parents("tr").find("td:eq(0)").text());
         ...
         $("#memberForm").attr("action", "i_q_bupdate.action");
      });
...
<!-- 메인 콘텐츠 -->
<div class="container" style="width:1600px; margin: 0px 70px 20px 55px;" align="left" >

	<div class="panel-group" style="border: px solid; width: 1600px;">
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            <form action="i_q_bupdate.action" method="post" role="form" id="memberForm">
            
            	<div class="form-group" style="display:none;" id="nun_dp">
                  <label for="문제번호">
                     문제번호: 
                  </label>
                  <input type="text" id="num" name="num" class="form-control" readonly="readonly">
               </div>
               ...
               <div class="form-group"style="display:none;" id="chhioce2_dp">
                  <label for="보기2">
                     보기2: 
                  </label>
     ...
     <!-- -------------------------------------------------------- 여기서부터 리스트 출력 ------------------------------------------------------------------- -->
      ...
      <div class="panel panel-default" style="width: 1830px;  magin: 20px;">
               ...
               <tbody>
                 	...
                 	<c:forEach var="member" items="${list }">
						<tr>
							...
							<td>
								<button type="button" class="btn btn-primary btn-xs btnDelete" onclick="location='i_q_bdelete.action?num=${member.num }'">삭제</button>
								<button type="button" class="btn btn-primary btn-xs btnUpdate" value="${member.num }" onclick="$('html').animate({scrollTop : 0}, 100)">수정</button>
							</td>
						</tr>
						</c:forEach>
               </tbody>
