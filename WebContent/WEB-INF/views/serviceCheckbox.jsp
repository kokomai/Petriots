...
<div class="multipl-image-checkbox"> 
   <ul>
        <li><input type="checkbox" id="walk_c" class="se1"${dto.walk == 1 ? "checked='checked'" : "" }/>
    ...
    <li><input type="checkbox" id="beauty_c" class="se2"  ${dto.beauty == 1 ? "checked='checked'" : "" }/>
    ...
    <li><input type="checkbox" id="snack_c" class="se3"  ${dto.snack == 1 ? "checked='checked'" : "" }/>
    ...
    <li><input type="checkbox" id="pick_up_c" class="se4"  ${dto.pick_up == 1 ? "checked='checked'" : "" }/>
    ...
    <li><input type="checkbox" id="medication_c" class="se5"  ${dto.medication == 1 ? "checked='checked'" : "" }/>
