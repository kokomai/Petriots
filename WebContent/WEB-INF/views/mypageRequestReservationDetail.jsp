...
<div class="container" style="padding-left: 200px;">
   ...
   <div class="col-lg-12" style="width:80%;">
         ...
         <form action="usercancelapprovereserve.action" method="post" id="cancelform">
              ...
              <div class="card-media">
               ...
               <!-- 여길 c:if로 하든, 다르게 하던 해야함(지난 정보의 경우) -->
                          <!--  <button type="submit" id="petsitter-submit" class="btn btn-success" value="예약번호">
                           ...
                           <a data-toggle="modal" href="#myModal1" class="btn btn-danger">취소하기</a>
            ...
            <div id="content">
               <div class="form-group">
                  <div class="input-group">
                     ...
                     <input type="text" id="txtCount" class="form-control" readonly="readonly" value="대상 펫시터"/>
                  </div>
                  <br />
                  <div class="input-group">
                  </div>
