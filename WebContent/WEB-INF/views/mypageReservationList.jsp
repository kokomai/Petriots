...
<div class="container">
   ...
   <div class="row" style="display:flex; flex-direction: row;">
      ...
      <div class="card-header" style="width: 100%; background-color: rgba(108, 201, 251,0.3)">지난 위탁 정보</div>
      
         <!-- 지난 위탁 정보 -->
         <c:forEach var="list" items="${reservelist }"><!-- 펫시터 프로필이 입력되고 위탁중인 정보 있을때 띄워주기 -->
			<form action="userreservelistdetail.action" method="GET" id="reservedetailForm${list.r_a_num }" class="reservedetailForm">
			<!-- 위탁중인 정보 -->
