...
function sendIt()
{
	...
	f.action = "<%=cp%>/answerupdatedok.action?aNum=${aNum}&qNum=${qNum}&pageNum=${pageNum}";
	...
	<form method="post" name="myForm">
		<table class="table table-borderd" id="tblAdd">
			<tr>
				...
				<td>
					<input type="text" name="userId" class="form-control" size="35" maxlength="20" value="${dto.userId}" placeholder="이름을 입력하세요">
				</td>
			</tr>
			
			<tr>
				<th>내용</th>
				<td><textarea name="content" id="summernote">${dto.aMaintext}</textarea></td>
			</tr>
		</table>
