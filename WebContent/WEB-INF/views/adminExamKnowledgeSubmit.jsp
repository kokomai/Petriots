...
<title>adminExamKnowledgeSubmit.jsp</title>
...
<div class="container" >
	...
	<div class="row" style="display:flex; flex-direction: row; height: 600px; margin: 20px 0px 0px 120px;">
					...
					<div class="card-header" style="width: 100%; background-color: rgba(108, 201, 251,0.3); margin-top: 10px;">지식 검사 문제 제출</div>
					
					<div class="card-body" style="display:flex; flex-direction: row; width:100%; height:100%; ">
						
						<div style=" width: 100%; height: 100%; padding: 6px;">
						
						<form action="i_q_binsert.action" method="post" role="form">
	                    	...
	                    	<div class="form-group">
						     ...
						     <a class="btn btn-secondary" href="http://localhost:8090/mybatisWork03/adminMypage.jsp" style="float:right;">
						         문제제출취소
						     </a>
...
<!-- Footer -->
	<footer class="py-5" style="padding-left: 70px;  width:1900px; background-color: rgba(108, 201, 251,0.3); margin: 150px 120px 10px 10px;">
		<div class="container">
