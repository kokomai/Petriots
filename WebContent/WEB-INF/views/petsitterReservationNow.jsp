...
<title>Petriots! | 위탁 중 / 예약 중</title>
	...
	$(function()
		{
			...
			$(".approvedetail").click(function()
					{
						var num = $(this).attr('id');
						
						/* alert(num); */
						 $("#approvedetailForm"+num).submit();
					});
		});
...
<div class="container">
	...
	<div class="row" style="display:flex; flex-direction: row;">
		...
		<div class="col-lg-12" align="center" style=" background-color:rgba(108, 201, 251,0.3);">
			<div style="height:30px;"><span style="font-size: 15pt; font-weight: bold;">위탁 중인 항목</span></div>
			
			<c:forEach var="list" items="${reservenowlist }"><!-- 펫시터 프로필이 입력되고 위탁중인 정보 있을때 띄워주기 -->
			<!-- 위탁중인 정보 -->
		...
		<div class="col-lg-12" align="center" style="border: 1px solid silver;">
			<div style="height:30px;"><span style="font-size: 15pt; font-weight: bold;">승인한 예약건</span></div>
	    	<c:forEach var="list" items="${reserveapprovelist }"><!-- 펫시터 프로필이 입력되고 위탁중인 정보 있을때 띄워주기 -->
	    	<form action="petsitterapprovedetail.action" method="GET" id="approvedetailForm${list.r_a_num }" class="approvedetailForm">
			<!-- 위탁중인 정보 -->
				<div class="container_card">
				  ...
				  <div class="card-media">
				    ...
				    <div class="card-media-body">
				      ...
				      <div class="card-media-body-supporting-bottom card-media-body-supporting-bottom-reveal">
				        <span class="card-media-body-supporting-bottom-text subtle">맡긴 반려동물 : <span style="font-weight: bold;">${list.pet_name }</span></span>
				        <a href="#" class="card-media-body-supporting-bottom-text card-media-link u-float-right approvedetail" id="${list.r_a_num }">더보기</a>
				        <input type="text" name="r_a_num" value="${list.r_a_num }" hidden="hidden">
				      </div>
				    </div>
				  </div>
			...
			<!-- // 위탁중인 정보 없을 때.. -->
			<c:if test="${empty reserveapprovelist }">
				<div class="container_card">
