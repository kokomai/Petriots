...
<div class="container">
   ...
   <div class="row" style="display:flex; flex-direction: row;">
      ...
      <div class="card-header" style="width: 100%; background-color: rgba(108, 201, 251,0.3)">요청중인 예약</div>
      
         <!-- 요청 예약 정보 -->
         <c:forEach var="list" items="${reserverequestlist }">
			<form action="userrequestdetail.action" method="GET" id="requestdetailForm${list.r_a_num }" class="requestdetailForm">
			<!-- 요청된 위탁 정보 -->
