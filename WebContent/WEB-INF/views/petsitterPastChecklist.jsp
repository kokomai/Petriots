...
<div id="check_wrapper" >
	...
	<div id="form_div" style="width:75%">
	 ...
	 <form id="check_form${list.c_c_num }" method="post" action="checklistcheckok.action" >
	   ...
	   <tr id="row${status.index+1 }">
	    ...
	    <div class="checkbox custom">
	    	<!-- 불러올 때 이미 체크 했으면, checked 속성을 부여하고 disabled를 해야 함.. -->
	   		...
	   		${list.excute == 'Y' ? "checked='checked'" : "" } disabled="disabled"  >
	   		<!-- 여기엔 커서를 디폴트로.. -->
	    ...
	    <td>
	    	<input type="time" name="cksttdate" placeholder="시작 시간" class="timefont" value="${list.cksttdate }" readonly="readonly">
	    </td>
	     <td>
	  ...
	  <!-- <input class ="" type="button" onclick="check()" style="width:30%;" value="적용 하기"> -->
