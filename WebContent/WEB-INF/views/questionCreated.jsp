...
{	
	...
	f.action = "<%=cp%>/questioncreatedok.action";
	...
	<form method="post" name="myForm">
		<table class="table table-borderd" id="tblAdd">
			...
			<tr>
				<th>제목</th>
				<td>
					<input type="text" name="qSubject" class="form-control" size="74" maxlength="100" placeholder="제목을 입력하세요">
				</td>
			</tr>
		...
		<div id="bbsCreated_footer">
			...
			<input type="reset" value="다시입력" class="btn btn-info" onclick="document.myForm.qSubject.focus()">
			<input type="button" value="작성취소" class="btn btn-danger" onclick="javascript:location.href='<%=cp%>/questionlist.action'">			
